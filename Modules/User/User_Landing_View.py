...
class User_Landing_View:
    ...
    def __init__(self):
        ...
        self.logout_button = Button(self.window, image=self.logout_image, borderwidth=0, highlightthickness=0,
                                    relief="flat", bg="#EDC9F5", activebackground = "#EDC9F5", command=lambda: up.User_Landing_process.log_out_button_handle(self))
        ...
        self.items_button = Button(self.window, image=self.items_image, borderwidth=0, highlightthickness=0,
                                   relief="flat", bg="#C5CAFA", activebackground = "#C5CAFA", command=lambda: up.User_Landing_process.items_button_handle(self))
        ...
        self.shopnow_button = Button(self.window, image=self.shopnow_image, borderwidth=0, highlightthickness=0,
                                     relief="flat", bg="#C6C5FB", activebackground = "#C6C5FB", command=lambda: up.User_Landing_process.shop_button_handle(self))
